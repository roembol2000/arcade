// Canvas Asteroids
//"Geleend" van http://www.dougmcinnes.com/html-5-asteroids

KEY_CODES = {
  65: 'space', //Egienlijk A maar handiger
  37: 'left',
  38: 'up',
  39: 'right',
  40: 'down',
...
Game = {
  ...
  FSM: {
    ...
    waiting: function () {
      Text.renderText(window.ipad ? 'Touch Screen to Start' : 'Press A/B to Start', 36, Game.canvasWidth/2 - 270, Game.canvasHeight/2);
